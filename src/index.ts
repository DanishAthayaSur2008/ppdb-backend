...
const allowedOrigins = [
  "http://localhost:3000",
  "https://ppdb-user.vercel.app",
  "https://ppdb-admin.vercel.app",
  "https://ppdb.example.com",
];

// ✅ Ganti konfigurasi cors() dengan versi ini:
app.use(
  cors({
    origin: (origin, callback) => {
      // Allow requests tanpa origin (seperti dari form HTML internal)
...
// ==================================================
// 🧩 REDIRECT: /reset-password → /api/auth/reset-password
// ==================================================
app.get("/reset-password", (req: Request, res: Response) => {
  const queryString = new URLSearchParams(req.query as any).toString();
  res.redirect(`/api/auth/reset-password?${queryString}`);
});
